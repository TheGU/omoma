...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Category._order'
        db.delete_column('transactions_category', '_order')


    def backwards(self, orm):
        
        # Adding field 'Category._order'
        db.add_column('transactions_category', '_order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
